...
export interface Database {
  public: {
    ...
    Enums: {
      ...
      supplier_request_type:SupplierRequestType;supplier_request_status:SupplierRequestStatus;supplier_response_type:SupplierResponseType;quotation_status:QuotationStatus;supplier_selection_status:SupplierSelectionStatus;
    };
