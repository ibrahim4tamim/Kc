...
export type SupplierSelectionStatus="active"|"superseded"|"cancelled"|"archived";
export type PurchaseOrderStatus="draft"|"approved"|"issued"|"acknowledged"|"cancelled"|"superseded"|"archived";
export type PaymentScheduleType="deposit"|"progress"|"balance"|"final"|"other"; export type PaymentMethod="bank_transfer"|"wise"|"alipay"|"wechat_pay"|"cash"|"other";
...
export type RfqAttachmentOwnerType = "rfq" | "rfq_item" | "supplier_response" | "quotation" | "purchase_order" | "payment_record";
export type RfqActivityEventType = "rfq_created" | "rfq_submitted" | "rfq_status_changed" | "rfq_updated" | "rfq_item_created" | "rfq_item_updated" | "rfq_item_status_changed" | "attachment_added" | "attachment_archived" | "supplier_request_created" | "supplier_request_sent" | "supplier_response_received" | "supplier_request_completed" | "supplier_request_cancelled" | "quotation_received" | "quotation_revised" | "quotation_status_changed" | "quote_comparison_reviewed" | "supplier_selected" | "supplier_selection_changed" | "supplier_selection_cancelled" | "purchase_order_created" | "purchase_order_approved" | "purchase_order_issued" | "purchase_order_revised" | "purchase_order_cancelled" | "payment_schedule_created" | "payment_recorded" | "payment_partially_completed" | "payment_completed";
...
export interface Database {
  public: {
    Tables: {
      ...
      supplier_selections:{Row:{id:string;organization_id:string;rfq_id:string;rfq_item_id:string;supplier_candidate_id:string;supplier_id:string;quotation_id:string;selected_by_profile_id:string;selected_at:string;selection_reason:string;fewer_than_three_justification:string|null;status:SupplierSelectionStatus;superseded_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string};Insert:{id?:string;organization_id:string;rfq_id:string;rfq_item_id:string;supplier_candidate_id:string;supplier_id:string;quotation_id:string;selected_by_profile_id:string;selected_at?:string;selection_reason:string;fewer_than_three_justification?:string|null;status?:SupplierSelectionStatus;superseded_at?:string|null;cancelled_at?:string|null;archived_at?:string|null;created_at?:string;updated_at?:string};Update:Partial<Omit<Database["public"]["Tables"]["supplier_selections"]["Row"],"id"|"organization_id"|"rfq_id"|"rfq_item_id"|"supplier_candidate_id"|"supplier_id"|"quotation_id"|"selected_by_profile_id"|"selected_at"|"selection_reason"|"created_at">>;Relationships:[]};
      purchase_orders:{Row:{id:string;organization_id:string;purchase_order_number:string;version_number:number;rfq_id:string;rfq_item_id:string;supplier_id:string;supplier_candidate_id:string;supplier_selection_id:string;quotation_id:string;status:PurchaseOrderStatus;currency:string;order_date:string;expected_delivery_date:string|null;incoterm:string|null;payment_terms:string|null;supplier_reference:string|null;internal_notes:string|null;supplier_notes:string|null;created_by:string;approved_by:string|null;approved_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string};Insert:{id?:string;organization_id:string;purchase_order_number:string;version_number:number;rfq_id:string;rfq_item_id:string;supplier_id:string;supplier_candidate_id:string;supplier_selection_id:string;quotation_id:string;status?:PurchaseOrderStatus;currency:string;order_date?:string;expected_delivery_date?:string|null;incoterm?:string|null;payment_terms?:string|null;supplier_reference?:string|null;internal_notes?:string|null;supplier_notes?:string|null;created_by:string;approved_by?:string|null;approved_at?:string|null;cancelled_at?:string|null;archived_at?:string|null;created_at?:string;updated_at?:string};Update:Partial<Omit<Database["public"]["Tables"]["purchase_orders"]["Row"],"id"|"organization_id"|"purchase_order_number"|"version_number"|"rfq_id"|"rfq_item_id"|"supplier_id"|"supplier_candidate_id"|"supplier_selection_id"|"quotation_id"|"currency"|"order_date"|"created_by"|"created_at">>;Relationships:[]};
      payment_schedules:{Row:{id:string;organization_id:string;purchase_order_id:string;sequence_number:number;payment_type:PaymentScheduleType;description:string|null;expected_amount:number;currency:string;percentage:number|null;due_date:string|null;notes_internal:string|null;archived_at:string|null;created_at:string;updated_at:string};Insert:{organization_id:string;purchase_order_id:string;sequence_number:number;payment_type:PaymentScheduleType;expected_amount:number;currency:string;description?:string|null;percentage?:number|null;due_date?:string|null;notes_internal?:string|null;archived_at?:string|null};Update:Partial<Omit<Database["public"]["Tables"]["payment_schedules"]["Row"],"id"|"organization_id"|"purchase_order_id"|"sequence_number"|"currency"|"created_at">>;Relationships:[]};
      purchase_order_items:{Row:{id:string;organization_id:string;purchase_order_id:string;rfq_item_id:string;quotation_item_id:string|null;quantity:number;unit:string;unit_price:number;currency:string;line_total:number;product_description:string|null;moq:number|null;agreed_lead_time_days:number|null;packaging_notes:string|null;supplier_notes:string|null;internal_notes:string|null;archived_at:string|null;created_at:string;updated_at:string};Insert:{id?:string;organization_id:string;purchase_order_id:string;rfq_item_id:string;quotation_item_id?:string|null;quantity:number;unit:string;unit_price:number;currency:string;product_description?:string|null;moq?:number|null;agreed_lead_time_days?:number|null;packaging_notes?:string|null;supplier_notes?:string|null;internal_notes?:string|null;archived_at?:string|null};Update:Partial<Omit<Database["public"]["Tables"]["purchase_order_items"]["Row"],"id"|"organization_id"|"purchase_order_id"|"rfq_item_id"|"quotation_item_id"|"currency"|"line_total"|"created_at">>;Relationships:[]};
      payment_records:{Row:{id:string;organization_id:string;purchase_order_id:string;payment_schedule_id:string|null;supplier_id:string;amount:number;currency:string;paid_at:string;payment_method:PaymentMethod;external_reference:string|null;notes_internal:string|null;recorded_by:string;archived_at:string|null;created_at:string;updated_at:string};Insert:{organization_id:string;purchase_order_id:string;payment_schedule_id?:string|null;supplier_id:string;amount:number;currency:string;paid_at:string;payment_method:PaymentMethod;external_reference?:string|null;notes_internal?:string|null;recorded_by:string;archived_at?:string|null};Update:Partial<Omit<Database["public"]["Tables"]["payment_records"]["Row"],"id"|"organization_id"|"purchase_order_id"|"payment_schedule_id"|"supplier_id"|"currency"|"recorded_by"|"created_at">>;Relationships:[]};
    };
    ...
    Functions: {
      ...
      record_supplier_selection:{Args:{target_organization_id:string;target_rfq_id:string;target_rfq_item_id:string;target_supplier_candidate_id:string;target_supplier_id:string;target_quotation_id:string;target_selection_reason:string;target_fewer_than_three_justification:string|null;allow_replacement:boolean};Returns:Array<{id:string;organization_id:string;rfq_id:string;rfq_item_id:string;supplier_candidate_id:string;supplier_id:string;quotation_id:string;selected_by_profile_id:string;selected_at:string;selection_reason:string;fewer_than_three_justification:string|null;status:SupplierSelectionStatus;superseded_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string}>};
      cancel_supplier_selection:{Args:{target_organization_id:string;target_selection_id:string;target_reason:string};Returns:Array<{id:string;organization_id:string;rfq_id:string;rfq_item_id:string;supplier_candidate_id:string;supplier_id:string;quotation_id:string;selected_by_profile_id:string;selected_at:string;selection_reason:string;fewer_than_three_justification:string|null;status:SupplierSelectionStatus;superseded_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string}>};
      create_purchase_order_from_selection:{Args:{target_organization_id:string;target_supplier_selection_id:string;target_order_date:string;target_expected_delivery_date:string|null;target_supplier_reference:string|null;target_internal_notes:string|null;target_supplier_notes:string|null};Returns:Array<{id:string;organization_id:string;purchase_order_number:string;version_number:number;rfq_id:string;rfq_item_id:string;supplier_id:string;supplier_candidate_id:string;supplier_selection_id:string;quotation_id:string;status:PurchaseOrderStatus;currency:string;order_date:string;expected_delivery_date:string|null;incoterm:string|null;payment_terms:string|null;supplier_reference:string|null;internal_notes:string|null;supplier_notes:string|null;created_by:string;approved_by:string|null;approved_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string}>};
      create_purchase_order_revision:{Args:{target_organization_id:string;target_purchase_order_id:string;target_internal_notes:string|null;target_supplier_notes:string|null};Returns:Array<{id:string;organization_id:string;purchase_order_number:string;version_number:number;rfq_id:string;rfq_item_id:string;supplier_id:string;supplier_candidate_id:string;supplier_selection_id:string;quotation_id:string;status:PurchaseOrderStatus;currency:string;order_date:string;expected_delivery_date:string|null;incoterm:string|null;payment_terms:string|null;supplier_reference:string|null;internal_notes:string|null;supplier_notes:string|null;created_by:string;approved_by:string|null;approved_at:string|null;cancelled_at:string|null;archived_at:string|null;created_at:string;updated_at:string}>};
    };
    Enums: {
      app_role: AppRole;
      ...
      supplier_request_type:SupplierRequestType;supplier_request_status:SupplierRequestStatus;supplier_response_type:SupplierResponseType;quotation_status:QuotationStatus;supplier_selection_status:SupplierSelectionStatus;purchase_order_status:PurchaseOrderStatus;
    };
