...
export type RfqAttachmentOwnerType = "rfq" | "rfq_item" | "supplier_response" | "quotation" | "purchase_order";
...
export interface Database {
  public: {
    Tables: {
      ...
      purchase_order_items:{Row:{id:string;organization_id:string;purchase_order_id:string;rfq_item_id:string;quotation_item_id:string|null;quantity:number;unit:string;unit_price:number;currency:string;line_total:number;product_description:string|null;moq:number|null;agreed_lead_time_days:number|null;packaging_notes:string|null;supplier_notes:string|null;internal_notes:string|null;archived_at:string|null;created_at:string;updated_at:string};Insert:{id?:string;organization_id:string;purchase_order_id:string;rfq_item_id:string;quotation_item_id?:string|null;quantity:number;unit:string;unit_price:number;currency:string;product_description?:string|null;moq?:number|null;agreed_lead_time_days?:number|null;packaging_notes?:string|null;supplier_notes?:string|null;internal_notes?:string|null;archived_at?:string|null;created_at?:string;updated_at?:string};Update:Partial<Omit<Database["public"]["Tables"]["purchase_order_items"]["Row"],"id"|"organization_id"|"purchase_order_id"|"rfq_item_id"|"quotation_item_id"|"currency"|"line_total"|"created_at">>;Relationships:[]};
    };
